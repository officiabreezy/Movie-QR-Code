...
import { Movie } from '../qr/qr.service'; // Assuming you have a Movie interface def

@Injectable()
export class MovieService {
  private readonly allMovies = [
    {Title: "Avatar",
    ...
    {Title: "I Am Legend",
     image:"https://images-na.ssl-images-amazon.com/images/M/MV5BMTc5MDM1OTU5OV5BMl5BanBnXkFtZTYwMjA0Nzc4._V1_.jpg"
    },
    {Title: "300",
    ...
    {Title: "Vikings",
     image:"https://images-na.ssl-images-amazon.com/images/M/MV5BNzU2NDcxODMyOF5BMl5BanBnXkFtZTgwNDAzOTI2ODE@._V1_.jpg"
    },
    {Title: "Narcos",
  ...
  getRandomMovies(count = 10): Movie[] {
